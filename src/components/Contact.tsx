  ...
  return (
    <section id="contact" ref={sectionRef} className="relative py-24 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className={`card-glass rounded-2xl p-6 sm:p-8 md:p-12 shadow-card hover:shadow-glow transition-all duration-700 group relative ${isVisible ? "animate-scale-in" : "opacity-0"}`} style={{ animationDelay: "0.2s" }}>
